...
This file is the agent on-ramp for **dungeon-synth-releases**. AGENTS.md covers Next 16 rules; this file covers what's specific to this codebase. For the wider ecosystem (data pipeline that feeds Supabase, sibling packages, overall direction), see `~/Coding/Music/CLAUDE.md`.
